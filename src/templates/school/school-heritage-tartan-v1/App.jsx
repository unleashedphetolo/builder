...
import "./styles/heritage-tartan.css";
...
function normalizeSectionForDefinition(section = {}, definition, slug, index = 0) {
  ...
  return {
    ...
    templateKey: section?.templateKey || section?.template_key || "school-heritage-tartan-v1",
    template_key: section?.template_key || section?.templateKey || "school-heritage-tartan-v1",
...
export default function App(props) {
  ...
  */
  ...
  return (
    <div className="school-heritage-tartan-v1-root">
      <ScrollToTop />
