...
import "./styles/sports-academy.css";
...
function normalizeSectionForDefinition(section = {}, definition, slug, index = 0) {
  ...
  return {
    ...
    templateKey: section?.templateKey || section?.template_key || "school-sports-academy-v1",
    template_key: section?.template_key || section?.templateKey || "school-sports-academy-v1",
...
export default function App(props) {
  ...
  */
  ...
  return (
    <div className="school-sports-academy-v1-root">
      <ScrollToTop />
