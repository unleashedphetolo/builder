...
function normalizeSectionForDefinition(section = {}, definition, slug, index = 0) {
  ...
  return {
    ...
    templateKey: section?.templateKey || section?.template_key || "school-evergreen-v1",
    template_key: section?.template_key || section?.templateKey || "school-evergreen-v1",
...
export default function App(props) {
  ...
  */
  ...
  return (
    <div className="school-evergreen-v1-root">
      <ScrollToTop />
