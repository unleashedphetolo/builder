...
export const templateConfig = {
  ...
  description:
    "A black-and-gold enterprise school website template with hero-overlay navigation, admissions, resources, governance, gallery, news, notices and contact.",
