...
function normalizeSectionForDefinition(section = {}, definition, slug, index = 0) {
  ...
  return {
    ...
    templateKey: section?.templateKey || section?.template_key || "school-institutional-v1",
    template_key: section?.template_key || section?.templateKey || "school-institutional-v1",
