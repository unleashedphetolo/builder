...
import "./styles/academic-tweed.css";
...
function normalizeSectionForDefinition(section = {}, definition, slug, index = 0) {
  ...
  return {
    ...
    templateKey: section?.templateKey || section?.template_key || "school-academic-tweed-v1",
    template_key: section?.template_key || section?.templateKey || "school-academic-tweed-v1",
...
export default function App(props) {
  ...
  */
  ...
  return (
    <div className="school-academic-tweed-v1-root">
      <ScrollToTop />
