...
import "./styles/boarding-school.css";
...
function normalizeSectionForDefinition(section = {}, definition, slug, index = 0) {
  ...
  return {
    ...
    templateKey: section?.templateKey || section?.template_key || "school-boarding-school-v1",
    template_key: section?.template_key || section?.templateKey || "school-boarding-school-v1",
  ...
  return normalizeSectionForDefinition(
    {
      ...
      templateKey: "school-boarding-school-v1",
...
export default function App(props) {
  ...
  */
  ...
  return (
    <div className={`school-boarding-school-v1-root ${slug === "/" ? "prestige-home" : "prestige-inner"}`}> 
      <ScrollToTop />
