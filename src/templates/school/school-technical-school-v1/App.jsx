...
import "./styles/technical-school.css";
...
function normalizeSectionForDefinition(section = {}, definition, slug, index = 0) {
  ...
  return {
    ...
    templateKey: section?.templateKey || section?.template_key || "school-technical-school-v1",
    template_key: section?.template_key || section?.templateKey || "school-technical-school-v1",
...
export default function App(props) {
  ...
  */
  ...
  return (
    <div className="school-technical-school-v1-root">
      <ScrollToTop />
