...
export default function App({
  ...
  const rootStyle = {
    "--primary": safeSettings.primary_color || "#020617",
    "--secondary": safeSettings.secondary_color || "#020617",
    "--accent": safeSettings.accent_color || "#d4af37",
  ...
  return (
    <div
      className={`business-finance-template ${previewMode ? "is-preview" : ""} ${templatePreviewMode ? "is-template-preview" : ""} ${miniPreview ? "is-mini-preview" : ""}`}
      style={rootStyle}
    >
