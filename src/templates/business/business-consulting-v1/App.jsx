...
export default function App({
  ...
  const rootStyle = {
    "--primary": safeSettings.primary_color || "#0f766e",
    "--secondary": safeSettings.secondary_color || "#134e4a",
    "--accent": safeSettings.accent_color || "#f97316",
    "--background": safeSettings.background_color || "#f0fdfa",
    "--font": safeSettings.font_family || 'Inter, "Segoe UI", Arial, sans-serif',
  };

  return (
    <div
      className={`business-consulting-template ${previewMode ? "is-preview" : ""} ${templatePreviewMode ? "is-template-preview" : ""} ${miniPreview ? "is-mini-preview" : ""}`}
      style={rootStyle}
    >
