...
export default function App({
  ...
  const rootStyle = {
    "--primary": safeSettings.primary_color || "#6d28d9",
    "--secondary": safeSettings.secondary_color || "#111827",
    "--accent": safeSettings.accent_color || "#06b6d4",
    "--background": safeSettings.background_color || "#faf5ff",
    "--font": safeSettings.font_family || 'Inter, "Segoe UI", Arial, sans-serif',
  };

  return (
    <div
      className={`business-agency-template ${previewMode ? "is-preview" : ""} ${templatePreviewMode ? "is-template-preview" : ""} ${miniPreview ? "is-mini-preview" : ""}`}
      style={rootStyle}
    >
