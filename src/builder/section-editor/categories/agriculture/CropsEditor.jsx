...
const createId = () => `cropseditor-${Date.now()}-${Math.round(Math.random() * 100000)}`;

export default function CropsEditor({ draftContent = {}, updateContent }) {
  return (
    <>
