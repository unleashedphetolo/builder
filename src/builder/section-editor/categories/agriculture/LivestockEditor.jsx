...
const createId = () => `livestockeditor-${Date.now()}-${Math.round(Math.random() * 100000)}`;

export default function LivestockEditor({ draftContent = {}, updateContent }) {
  return (
    <>
      ...
      <ItemCollection
        ...
        addLabel="Add Item"
        emptyText="No livestock configured."
