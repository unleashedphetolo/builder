...
const createId = () => `solutionseditor-${Date.now()}-${Math.round(Math.random() * 100000)}`;

export default function SolutionsEditor({ draftContent = {}, updateContent }) {
  return (
    <>
      ...
      <ItemCollection
        ...
        addLabel="Add Item"
        emptyText="No solutions configured."
